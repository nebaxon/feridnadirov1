...
<head>
    ...
    <script src="https://unpkg.com/scrollreveal@4.0.0/src/scrollreveal.min.js"></script>
</head>
                        ...
                        <?php for ($i = 0; $i < 4; $i++) { ?>
                            ...
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">A pseudo-Latin text used in web design, layout, and printing in
                                        place of English to emphasise design elements.</p>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="pricing-inner section-inner has-top-divider">
                    ...
                    <div class="pricing-tables-wrap">
                        <?php
                        $array = array("starter" => "27", "Professional" => "97", "Business" => "147");
                                ...
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            <div class="pricing-table-title mt-12 mb-8"><?php echo $x; ?></div>
                                            <div class="pricing-table-price mb-32 pb-24"><span
                                                        class="pricing-table-price-currency h4">$</span><span
                                                        class="pricing-table-price-amount h2"><?php echo $val; ?></span>/mo
                                            </div>
                                        </div>
        ...
        <div class="container">
            <div class="site-footer-inner has-top-divider">
                ...
                <ul class="footer-links list-reset">
                    ...
                    $array1 = array("Contact" => "1", "About us" => "2", "FAQ's" => "3", "Support" => "4");

                    foreach ($array1 as $x1 => $val1) {
                        ?>
                        <li>
                            <a href="#"><?php echo $x1; ?></a>
                        </li>
                    <?php } ?>
                </ul>
